...
public class JqueryEvents {
    ...
    public static final native void addDomClickHandler(final HasClickHandlers w)/*-{
		if(w.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._hasClick) return;
		$wnd.$(w.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()).click(function(e) {
		...
		w.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._hasClick=true;
	}-*/;
    
    public static final native void addDomClickHandler(final HasClickHandlers w, final JavaScriptObject funct)/*-{
		if(w.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._hasClick) return;
		var elem = $wnd.$(w.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()());
		elem.click(funct);
    ...
    public static final native void addDomChangeHandler(final HasChangeHandlers c)/*-{
		if(c.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._hasChange) return;
		$wnd.$(c.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()).change(function(e) {
		...
		c.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._hasChange=true;
	}-*/;
    public static final native void addDomSubmitHandler(final HasSubmitHandler f)/*-{
    	if(f.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._submit) return;
    	$wnd.$(f.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()).submit(function(e) {
    	...
    	f.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()()._submit=true;
    }-*/;
    
    public static final native void attachChangeHandler(final HasValueChangeHandlers<Date> h)/*-{
    	var e = h.@usf.gwt.bootstrap.ui.core.Bootstrap::getBaseElement()();
